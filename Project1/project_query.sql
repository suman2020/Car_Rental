CREATE SCHEMA COMPANY_PROJECT;

CREATE TABLE COMPANY_PROJECT.EMPLOYEE (
...
CREATE TABLE COMPANY_PROJECT.DEPARTMENT (
...
CREATE TABLE COMPANY_PROJECT.DEPT_LOCATIONS (
...
CREATE TABLE COMPANY_PROJECT.PROJECT (
...
CREATE TABLE COMPANY_PROJECT.WORKS_ON (
